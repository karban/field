...
SceneViewPostInterface::SceneViewPostInterface(PostView *postHermes, QWidget *parent)
...
void SceneViewPostInterface::paintScalarFieldColorBar(double min, double max)
{
    ...
    // dimensions
    int textWidth = metrics.width(QString::number(-1.0, '+e', 2)) + 3;
